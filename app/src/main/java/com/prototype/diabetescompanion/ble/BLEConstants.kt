...
class BLEConstants {
    ...
    companion object {
        const val ACTION_GATT_CONNECTED =
            "com.np.lekotlin.ACTION_GATT_CONNECTED" //Strings representing actions to broadcast to activities
        const val ACTION_GATT_DISCONNECTED =
            "com.np.lekotlin.ACTION_GATT_DISCONNECTED" // Old com.zco.ble
        const val ACTION_GATT_SERVICES_DISCOVERED =
            "com.np.lekotlin.ACTION_GATT_SERVICES_DISCOVERED"
        ...
        const val BGL_SERVICE_UUID = "0000ffe0-0000-1000-8000-00805f9b34fb"
        const val BGL_CHAR_UUID = "0000ffe1-0000-1000-8000-00805f9b34fb"
